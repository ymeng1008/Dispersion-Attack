...
EMBER_DATA_DIR = '/home/nkamg02/Sparsity_Brings_Vunerabilities/Sparsity-Brings-Vunerabilities-main/datasets/ember/ember2018/'

# This is the directory containing the pdf dataset
PDF_DATA_DIR = 'datasets/pdf/' #存储 PDF 数据集的目录路径
DGA_DATA_DIR = 'datasets/dga/' #增加 存储DGA数据集的目录路径
PDF_DATA_CSV = 'data.csv' #An csv of extracted PDFs based on Mimicus 基于 Mimicus 工具提取的 PDF 文件的信息
DGA_DATA_CSV = 'data.csv'
...
# Directory containing Drebin data
Domain_DATA_DIR = 'datasets/domain/'

# Path to local dir where to save trained models
# SAVE_MODEL_DIR = 'models/'
SAVE_MODEL_DIR = 'modelstest/'
...
features_to_exclude = {
    ...
    'domain': infeasible_features_domain
}
